...
최근 확인 결과: 2026-06-10 07:58 KST GitHub Actions 자동 수집에서 YouTube는 22개 검색어, 관련 채널 80개, 최근 후보 163개를 검사했고 RSS 기반 후보 114개 중 23개가 조회수/Shorts 링크 기준을 통과했으며, 최종 랭킹 후보 16개 중 아직 없던 1개를 새로 추가했습니다. 이번 수정 작업 전체로 YouTube 데이터는 2,099개에서 2,123개로 24개 늘었습니다. Instagram은 공급자 API 비밀값이 없어 0개, Threads는 무조회수 공개 후보 72개를 후보 파일에만 저장했습니다.
