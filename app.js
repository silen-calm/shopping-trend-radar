...
function renderYoutubeCard(item) {
  return `<a class="card" href="https://www.youtube.com/shorts/${encodeURIComponent(item.id)}" target="_blank" rel="noopener">
    ...
    <div class="thumb">
      <img referrerpolicy="no-referrer" decoding="async" loading="lazy" src="${youtubeThumb(item)}" onerror="this.onerror=null;this.src='/assets/thumb-fallback.svg'">
...
function renderInstagramCard(item) {
  ...
  return `<a class="card" href="${escapeHtml(item.link)}" target="_blank" rel="noopener">
    ...
    <div class="thumb ig">
      ...
      ${image ? `<img referrerpolicy="no-referrer" decoding="async" loading="lazy" src="${image}" onerror="this.onerror=null;this.src='/assets/thumb-fallback.svg'">` : ""}
